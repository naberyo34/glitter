...
public class Actor {
  ...
  @Schema(description = "アクターの公開鍵情報", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public static class PublicKey {
    @Schema(description = "公開鍵の ID", example = "https://example.com/user/test_user#main-key", requiredMode = Schema.RequiredMode.REQUIRED)
    private String id;
    @Schema(description = "公開鍵のオーナー", example = "https://example.com/user/test_user", requiredMode = Schema.RequiredMode.REQUIRED)
    private String owner;
    @Schema(description = "公開鍵の値", example = "-----BEGIN PUBLIC KEY-----\n...\n-----END PUBLIC KEY-----\n", requiredMode = Schema.RequiredMode.REQUIRED)
