 ...
 * Actor Endpoint からの応答としてこれを返します。それ以外の用途では使いません。
...
public class Actor {
  ...
  @Schema(description = "アイコン画像", example = "https://example.com/bucketName/test_user/icon.jpg", requiredMode = Schema.RequiredMode.REQUIRED)
  private String[] icon;
